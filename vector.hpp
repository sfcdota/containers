...
namespace ft {
  ...
  class vector {
   public:
    ...
    typedef ft::const_random_access_iterator<random_access_iterator_tag, value_type> const_iterator;
...
//    }
    ...
    vector(InputIterator first, InputIterator last, const allocator_type &alloc = allocator_type(),
           ...
           typename enable_if<  is_integral<
               typename iterator_traits<
                   iterator_traits<InputIterator> >::iterator_category >::value, iterator>::type* = 0) // CORRECT
        : allocator_(alloc), array_(allocator_.allocate(1)), capacity_(0), size_(0)
    {
      assign(first, last);
    }
    ...
    void assign(InputIterator first, InputIterator last,
                ...
                typename enable_if<  is_integral<
                    typename iterator_traits<
                        iterator_traits<InputIterator> >::iterator_category >::value, iterator>::type* = 0)
